...
- thesis
publication:
  name: Master of Science thesis, Arizona State University
  short_name: M.S. thesis, ASU
summary: A DEVS-FMI adapter connects discrete-event models in DEVS-Suite with continuous physical models exported from OpenModelica. The thesis defines sensor and actuator interfaces and demonstrates the combined simulation approach with an electric scooter, supporting the development and evaluation of cyber-physical systems across different modeling tools.
tags:
- co-simulation
...
- url: https://keep.lib.asu.edu/items/161251
  type: custom
  label: ASU KEEP
- url: https://acims.asu.edu/phd-and-ms-thesis-reports-presentations
  type: custom
  label: ASU ACIMS
---
...
Xuanli Lin. *Co-simulation of Cyber-Physical Systems Using DEVS and Functional Mockup Units*. Master of Science thesis, Arizona State University, May 2021. ASU KEEP item 161251.
